...
ID3D11RasterizerState*	Renderer::m_rsCullModeNone{};
...
void Renderer::Init()
{
	...
	m_Device->CreateRasterizerState(&rasterizerDesc, &m_rsCullModeNone);
	...
	light.Diffuse = DirectX::XMFLOAT4(2.0f, 2.0f, 2.0f, 1.0f);
	SetLight(light);
...
void Renderer::Uninit()
{
	...
	m_rsCullModeBack->Release();
	m_rsCullModeFront->Release();
	m_rsCullModeNone->Release();
...
void Renderer::SetCullMode(D3D11_CULL_MODE CullMode)
{
	...
	case D3D11_CULL_NONE:
		m_DeviceContext->RSSetState(m_rsCullModeNone);
		break;
...
void Renderer::SetWorldViewProjection2D()
{
	...
	DirectX::XMStoreFloat4x4(&projection,
		DirectX::XMMatrixTranspose(
			DirectX::XMMatrixOrthographicOffCenterLH(0.0f, SCREEN_WIDTH, SCREEN_HEIGHT, 0.0f, 0.0f, 1.0f)
		)
	);
...
void Renderer::SetWorldMatrix(DirectX::XMFLOAT4X4* WorldMatrix)
{
	DirectX::XMFLOAT4X4 world;
	DirectX::XMStoreFloat4x4(&world,
		DirectX::XMMatrixTranspose(
...
void Renderer::SetViewMatrix(DirectX::XMFLOAT4X4* ViewMatrix)
{
	DirectX::XMFLOAT4X4 view;
	DirectX::XMStoreFloat4x4(&view,
		DirectX::XMMatrixTranspose(
...
void Renderer::SetProjectionMatrix(DirectX::XMFLOAT4X4* ProjectionMatrix )
{
	DirectX::XMFLOAT4X4 projection;
	DirectX::XMStoreFloat4x4(&projection,
		DirectX::XMMatrixTranspose(
